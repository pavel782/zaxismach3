...
Mach3Axis as2 = Mach3Axis();
Mach3Axis as3 = Mach3Axis();
Joystick joystick(VRX_PIN, VRY_PIN, SW_PIN);

Mach3Axis* axises[3] = { &as1, &as2, &as3 };
int axisCount = 3;//there used x,y,z
Mach3Axis* curAxis;
String startCommands[] = { "SETAXIS;X;160;false;150;0;200;-250;250;", "SETAXIS;Y;160;false;150;0;200;-250;250;", "SETAXIS;Z;240;false;150;0;200;-10;30;", "SETJS;true;Z;1;true;10;10;false;15;" };
int startCommandsCount = 4;
...
void setup() {
  ...
  axises[0]->stepsPerMm = 160;
  axises[0]->curMotorSpeed = 150;
  axises[0]->curMotorSpeed2 = 600;
  axises[0]->inverseMove = true;
  axises[0]->stepper = &stepper2;
  axises[0]->stepper->setMaxSpeed(1000.0);/*speed more than 1000 steps/sec is unstable*/
  axises[0]->stepper->setSpeed(600);

  axises[1]->axis = 'Y';
  axises[1]->disabled = false;
  axises[1]->stepsPerMm = 160;
  axises[1]->curMotorSpeed = 150;
  axises[1]->curMotorSpeed2 = 600;
  axises[1]->inverseMove = true;
  axises[1]->stepper = &stepper3;
  axises[1]->stepper->setMaxSpeed(1000.0);
  axises[1]->stepper->setSpeed(600);

  axises[2]->axis = 'Z';
  axises[2]->disabled = false;
  axises[2]->stepsPerMm = 240;
  axises[2]->curMotorSpeed = 150;
  axises[2]->curMotorSpeed2 = 600;
  axises[2]->stepper = &stepper1;
  axises[2]->stepper->setMaxSpeed(1000.0);
  axises[2]->stepper->setSpeed(600);
  curAxis = axises[2];
